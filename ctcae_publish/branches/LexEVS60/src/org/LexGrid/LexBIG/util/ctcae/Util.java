/*
 * Copyright: (c) 2004-2009 Mayo Foundation for Medical Education and 1
 ...
 */
class Util {
	static final private String _lineReturn = System
	        .getProperty("line.separator");
	static final private org.LexGrid.LexBIG.Impl.logging.Logger _logger = ResourceManager
	        .instance().getLogger();
	 ...
	 */
	static void displayTaggedMessage(String message, Throwable cause,
	        String logID) {
		...
		if (logID != null) {
			sb.append(_lineReturn).append("\t*** Refer to message with ID = ")
			        .append(logID).append(" in the log file.");
		}
	...
	static CodingSchemeSummary promptForCodeSystem() {
		return new SchemeSelectionMenu().displayAndGetSelection();
	}
